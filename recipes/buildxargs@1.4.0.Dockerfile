...
COPY --from=dep-l-pico-args-0.5.0-b8c41dbf50ca5479 /tmp/cargo-green--hack-caching--target-dir/release/deps/*-b8c41dbf50ca5479* /
...
COPY --from=dep-l-shlex-1.3.0-96a741f581f4126a /tmp/cargo-green--hack-caching--target-dir/release/deps/*-96a741f581f4126a* /
...
RUN \
  ...
  --mount=from=out-b8c41dbf50ca5479,dst=/tmp/cargo-green--hack-caching--target-dir/release/deps/libpico_args-b8c41dbf50ca5479.rmeta,source=/libpico_args-b8c41dbf50ca5479.rmeta \
  --mount=from=out-96a741f581f4126a,dst=/tmp/cargo-green--hack-caching--target-dir/release/deps/libshlex-96a741f581f4126a.rmeta,source=/libshlex-96a741f581f4126a.rmeta \
    { cat ./rustc-toolchain{,.toml} 2>/dev/null || true ; } && \
    env CARGO="$(which cargo)" \
...
RUN \
  --mount=from=cratesio-buildxargs-1.4.0,source=/extracted,dst=/home/pete/.cargo/registry/src/index.crates.io-0000000000000000/buildxargs-1.4.0 \
  --mount=from=out-d78f4de4a17f92cd,dst=/tmp/cargo-green--hack-caching--target-dir/release/deps/libbuildxargs-d78f4de4a17f92cd.rlib,source=/libbuildxargs-d78f4de4a17f92cd.rlib \
  --mount=from=out-b8c41dbf50ca5479,dst=/tmp/cargo-green--hack-caching--target-dir/release/deps/libpico_args-b8c41dbf50ca5479.rlib,source=/libpico_args-b8c41dbf50ca5479.rlib \
  --mount=from=out-96a741f581f4126a,dst=/tmp/cargo-green--hack-caching--target-dir/release/deps/libshlex-96a741f581f4126a.rlib,source=/libshlex-96a741f581f4126a.rlib \
    { cat ./rustc-toolchain{,.toml} 2>/dev/null || true ; } && \
    env CARGO="$(which cargo)" \
...
## ]
## stderr = [
##     '{"$message_type":"artifact","artifact":"/tmp/cargo-green--hack-caching--target-dir/release/deps/buildxargs-39127c16f4d70192.d","emit":"dep-info"}',
##     '{"$message_type":"artifact","artifact":"/tmp/cargo-green--hack-caching--target-dir/release/deps/buildxargs-39127c16f4d70192","emit":"link"}',
## ]
## 
## [[stages]]
## name = "rust-base"
